                ...
                <div class="collapse show">
                    <ul class="navbar-nav ml-auto">
                        <li class="header-text">
                            <p>Conoce, charla y diviértete con gente nueva</p>
                        </li>
                    </ul>
                </div>
              </nav>
                                                ...
                                                <form id="mysigninForm" autocomplete="off" action="" method="post">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                          <span class="login-input">
                                                          <input id="loginPassword" type="password" name="password" class="form-control" placeholder="Contraseña" autocomplete="off" />
                                                          </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-row social-login">
                                                        ...
                                                        <div class="form-group col-md-6 text-right">
                                                            <a class="forget-text" href="#">¿Contraseña olvidada?</a>
                                                        </div>
                                                    </div>
                                                    <div class="form-row mt-2">
                                                        <div class="form-group col-md-12 text-center">
                                                            <button class="btn-submit effect-1" id="loginButton">Iniciar sesión</button>
                                                        </div>
                                                    </div>
                                                  </form>
                                            </div>
                                        ...
                                        <div class="signup-col">
                                            <div class="signin-from">
                                                ...
                                                <form id="registrationForm" autocomplete="off" action="" method="post"></form>
                                                    ...
                                                    <div class="form-group col-md-3 mb-4">
                                                        <span class="signup-input">
                                                            <input type="password" name="password_token" class="form-control" placeholder="Contraseña" required />
                                                        </span>  
                                                    </div>
                                                    </div>
                                                    <div class="form-row">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-7">
                        <div class="comm-text-wrap">
                            <h2 class="heading-h2 mb-3 mb-lg-4">Transmita y viva sus sueños</h2>
                            <h5 class="heading-h5 pr-lg-4 mb-3 mb-lg-4">MiVida es la mejor aplicación de transmisión en vivo. Mira a los mejores talentos en vivo y en streaming.</h5>
                            <p class="text-p pr-lg-5">Desde la transmisión de video en vivo hasta la interacción en tiempo real, StreamKar le permite ver videos en vivo, transmitir su vida, chatear por video con sus amigos y hacer nuevos amigos en todo el mundo. No espere: únase a nosotros, transmita su vida, gane fans y haga nuevos amigos ahora.</p>
                        </div>
                    </div>
