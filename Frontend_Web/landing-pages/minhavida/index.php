                ...
                <div class="collapse show">
                    <ul class="navbar-nav ml-auto">
                        <li class="header-text">
                            <p>Conheça, converse e divirta-se com novas pessoas</p>
                        </li>
                    </ul>
                </div>
              </nav>
                                    ...
                                    <div class="login-row">
                                        <div class="signin-col">
                                            <div class="login-from">
                                                <h3 class="login-heading">Conecte-se</h3>
                                                <form id="mysigninForm" autocomplete="off" action="" method="post">
                                                    <div class="form-row">
                                                      <div class="form-group col-md-12 mb-4">
                                                        <span class="login-input">
                                                            <input id="loginUsername" type="email" name="email" class="form-control" placeholder="Nome do usuário" autocomplete="off" />
                                                        </span>  
                                                      </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                          <span class="login-input">
                                                          <input id="loginPassword" type="password" name="password" class="form-control" placeholder="Senha" autocomplete="off" />
                                                          </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-row social-login">
                                                        ...
                                                        <div class="form-group col-md-6 text-right">
                                                            <a class="forget-text" href="#">Esqueceu a senha?</a>
                                                        </div>
                                                    </div>
                                                    <div class="form-row mt-2">
                                                        <div class="form-group col-md-12 text-center">
                                                            <button class="btn-submit effect-1" id="loginButton">Conecte-se</button>
                                                        </div>
                                                    </div>
                                                  </form>
                                            </div>
                                        ...
                                        <div class="signup-col">
                                            <div class="signin-from">
                                                <h3 class="signup-heading">Novo em MinhaVida?</h3>
                                                <form id="registrationForm" autocomplete="off" action="" method="post">
                                                    <div class="form-row">
                                                      ...
                                                      <div class="form-group col-md-6 mb-4">
                                                            <span class="signup-input"><input name="email" type="email" class="form-control" placeholder="E-mail" required>
                                                        </span>  
                                                    </div>
                                                    <div class="form-group col-md-3 mb-4">
                                                        <span class="signup-input">
                                                            <input type="password" class="form-control" name="password_token" placeholder="Senha" required />
                                                        </span>  
                                                    </div>
                                                    </div>
                                                    <div class="form-row">
                                                    ...
                                                    <div class="form-row">
                                                      ...
                                                      <div class="form-row mt-2">
                                                        <div class="form-group col-md-12 text-center">
                                                            <button type="submit" id="registerButton" class="btn-signup effect-2">Inscribir-se</button>
                                                        </div>
                                                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-7">
                        <div class="comm-text-wrap">
                            <h2 class="heading-h2 mb-3 mb-lg-4">Transmita e viva seus sonhos</h2>
                            <h5 class="heading-h5 pr-lg-4 mb-3 mb-lg-4">MinhaVida é o melhor aplicativo de streaming ao vivo. Assista ao melhor talento ao vivo e transmita.</h5>
                            <p class="text-p pr-lg-5">De streaming de vídeo ao vivo a interação em tempo real, StreamKar permite que você assista a vídeos ao vivo, transmita sua vida, converse por vídeo com seus amigos e faça novos amigos globalmente. Não espere - Junte-se a nós, divulgue sua vida, ganhe fãs e faça novos amigos agora.</p>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-lg-6">
                        <div class="comm-text-wrap pr-lg-4">
                            ...
                            <p class="text-p">Abra-se para um novo círculo social. Conheça novos amigos, participe de entretenimento sem fim, discuta a vida e muito mais.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                ...
                <div class="row flex-row-reverse align-items-center pt-3">
                    <div class="col-md-6 col-lg-6">
                        <div class="comm-text-wrap pr-lg-4">
                            ...
                            <p class="text-p">Torne-se uma celebridade compartilhando sua vida com seus fãs. Seja amado pelas pessoas ao seu redor enquanto ganha a vida com o StreamKa</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                ...
                <div class="row flex-row-reverse justify-content-center align-items-center">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-mid">
                            <p>© 2021 MinhaVida <span>All rights reserved.</span></p>
                        </div>
                    </div>
